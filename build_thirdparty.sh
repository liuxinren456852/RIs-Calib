...
mkdir ${RIS_CALIB_ROOT_PATH}/src/ris_calib/thirdparty/ctraj/thirdparty/tiny-viewer-build
# shellcheck disable=SC2164
cd "${RIS_CALIB_ROOT_PATH}"/src/ris_calib/thirdparty/ctraj/thirdparty/tiny-viewer-build
...
mkdir ${RIS_CALIB_ROOT_PATH}/src/ris_calib/thirdparty/ctraj-build
# shellcheck disable=SC2164
cd "${RIS_CALIB_ROOT_PATH}"/src/ris_calib/thirdparty/ctraj-build
